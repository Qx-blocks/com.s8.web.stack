...
import { UnderlinedNavbar } from "./UnderlinedNavbar.js";
 ...
 * 
 */
export class UnderlinedNavbarMenu extends S8Object {



    /**
     * @type{UnderlinedNavbar}
     */
    navbar;
    ...
    constructor(){
        ...
        this.wrapperNode.classList.add("undernavbar-menu");

        this.labelNode = document.createElement("div");
        this.labelNode.classList.add("undernavbar-menu-label");
        this.wrapperNode.appendChild(this.labelNode);

        this.iconNode = document.createElement("div");
        this.iconNode.classList.add("undernavbar-menu-icon");
        this.labelNode.appendChild(this.iconNode);

        this.nameNode = document.createElement("div");
        this.nameNode.classList.add("undernavbar-menu-name");
